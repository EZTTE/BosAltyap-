...
message.channel.send("<a:greentiks:762618153724280842>**|** Başarıyla Botu Onayladınız.")
 ...
 message.guild.members.cache.get(sahip).roles.add(botlist.onaylıüye)
  message.guild.members.cache.get(sahip).send(` <a:onays:791202090235199499> **|** <@${botid}> Adlı Botunuz Onaylandı`)
  
  let embed = new Discord.MessageEmbed()
  .setColor("GREEN")
.setDescription(`<a:onays:791202090235199499>   **|**  <@${botid}> Adlı Bot Onaylandı Bot Sahip : <@${sahip}>.`)
